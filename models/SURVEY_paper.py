...
from torch_geometric.nn import ChebConv, SAGEConv, Set2Set, DenseGCNConv, dense_mincut_pool
...
class SURVEY_BA_2grid_SAGE(torch.nn.Module):
    def __init__(self, num_features=10, num_classes=2):
        super(SURVEY_BA_2grid_SAGE, self).__init__()
